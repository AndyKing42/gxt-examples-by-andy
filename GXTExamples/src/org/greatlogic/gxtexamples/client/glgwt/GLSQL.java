...
import org.greatlogic.gxtexamples.client.glgwt.IGLEnums.EGLJoinType;
...
private GLSQL(final EGLSQLType sqlType, final String tableName, final String dataSourceName) {
  ...
  _whereClauseList = Lists.newArrayList();
}
//--------------------------------------------------------------------------------------------------
/**
